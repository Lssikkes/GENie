...
-- you can remove any of the additional fields that are not required by your action.
	...
	newaction 
	{
		...
		shortname = "JSON Output",
		
		-- The description is shown in the help text (premake4 /help)
		description = "Export projects as a json blob",
		...
		onsolution = function(sln)
			premake.generate(sln, "%%.sln.json", premake.json.solution)
		end,

		onproject = function(prj)
			premake.generate(prj, "%%.prj.json", premake.json.project)
		end,
		...
		oncleansolution = function(sln)
			premake.clean.file(sln, "%%.sln.json")
		end,
		
		oncleanproject  = function(prj)
			premake.clean.file(prj, "%%.prj.json")
		end,
